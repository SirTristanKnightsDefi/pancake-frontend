...
import { useGhostShibaVIPContract } from 'hooks/useContract'
...
const GhostShibaVIPCard: React.FC<MiniSatProps> = ({ethereum, account}) => {
  ...
  const weAreSatoshiContract = useGhostShibaVIPContract();
  ...
  return (
    <FCard>
        ...
        <Divider />
        <Text><u>Links</u></Text>
        <Text><a href="https://t.me/GhostShibaofficial" target="_blank" rel="noreferrer">Telegram</a></Text>
        <Text><a href="https://lootex.io/stores/ghostshibavip" target="_blank" rel="noreferrer">Lootex</a></Text>
        <Text><a href="https://bscscan.com/address/0x38518cc7b92ec41586d2e4b8e80d022d0a8e3c6e#code" target="_blank" rel="noreferrer">NFT Contract</a></Text>        
    </FCard>
  )
}

export default GhostShibaVIPCard
