...
// lottery draws UTC: 11:00 (6 AM EST), 23:00 ( 6PM EST)
const lotteryDrawHoursUtc = [11, 23]
...
const getNextLotteryDrawTime = (currentMillis) => {
  ...
  const nextLotteryIsTomorrow = nextLotteryHour === 11 && currentHour >= 11 && currentHour <= 23
