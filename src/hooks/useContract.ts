...
import wearesatoshifreaksAbi from 'config/abi/wearesatoshifreaks.json'
...
export const useKingmaker = () => {
  const abi = (kingmakerAbi as unknown) as AbiItem
  return useContract(abi, getKingmakerAddress())
}
